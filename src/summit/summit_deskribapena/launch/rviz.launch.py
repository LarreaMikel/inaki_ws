...
def generate_launch_description():
    pkg_summit = FindPackageShare(package='summit_deskribapena').find('summit_deskribapena')
    robot_description = xacro.process_file(os.path.join(pkg_summit, 'models/summit2.urdf.xacro')).toxml()
    default_rviz_config_file = os.path.join(pkg_summit, 'rviz/urdf_config.rviz')
